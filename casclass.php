...
<body>
  ...
  <strong><i class="icon-user icon-large"></i>Class Schedule</strong>                                    
                                ...
                                <tbody>
                                    ...
                                    $query = mysqli_query($conn,"select * from classsched where department like '%SAS%' order by classid DESC") or die(mysqli_error());
                                    while ($row = mysqli_fetch_array($query)) {
                                        $id = $row['classid'];
										
																
										$query1 = mysqli_query($conn,"SELECT *FROM classsched where department like '%SAS%' order by classid DESC");
