						...
						<div class="hero-unit-table">   
                            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                    ...
                                    $query = mysqli_query($conn,"select * from examsched where department like '%CIT%' and status like '%unsaved%' and course_year_section like '%BSIS%' order by examid DESC") or die(mysqli_error());
                                    while ($row = mysqli_fetch_array($query)) {
                                        $id = $row['examid'];
										
																
										$query1 = mysqli_query($conn,"SELECT *FROM examsched where department like '%CIT%' and status like '%unsaved%' and course_year_section like '%BSIS%' order by examid DESC");
