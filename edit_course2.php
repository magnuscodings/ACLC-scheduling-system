                        ...
                        <div class="hero-unit-table">   
                          <div class="hero-unit-table">   
                            ...
                            <form class="form-horizontal" method="post" enctype="multipart/form-data">
                                ...
                                <div class="control-group">
                                    <div class="controls">
										...
										<span><a href = "CYS2.php" class = "btn btn-danger"> Back</a></span>
                                    </div>
                                </div>
                            </form>
                            ...
                            if (isset($_POST['update'])) {
                                ...
                                mysqli_query($conn,"update teachers set course='$course',year_section='$year_section' where courseid='$get_id'") or die(mysqli_query($conn,));
                             echo"Saved";
                            }
                            ?>
