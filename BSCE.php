						...
						<div class="hero-unit-table">   
                            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                    ...
                                    $query = mysqli_query($conn,"select * from classsched where department like '%CIT%' and status like '%unsaved%' and course_year_section like '%BSCE%' order by classid DESC") or die(mysqli_error());
                                    while ($row = mysqli_fetch_array($query)) {
                                        $id = $row['classid'];
										
																
										$query1 = mysqli_query($conn,"SELECT *FROM classsched where department like '%CIT%' and status like '%unsaved%' and course_year_section like '%BSCE%' order by classid DESC");
