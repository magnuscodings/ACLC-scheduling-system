                    ...
                    <div class="col-md-5 well">
                        <div class="hero-unit-table">   
                          <div class="hero-unit-table">   
                            ...
                            $query = mysqli_query($conn,"select * from classsched where classid='$get_id'") or die(mysqli_error());
...
while($CYS_row=mysqli_fetch_array($CYS_query)){
	...
	<option><?php echo $sy ?></option>
                                ...
                                <div class="control-group">
                                    <div class="controls">
										...
										<span><a href = "forclass.php" class = "btn btn-danger"> Back</a></span>
                                    </div>
                                </div>
                            </form>
 ...
 $query = mysqli_query($conn,"SELECT * FROM classsched WHERE day='$day' and time_start='$time_start' and time_end='$time_end' and fname='$fname'") or die (mysqli_error());
 $query1= mysqli_query($conn,"SELECT * FROM classsched WHERE day='$day' and time_start='$time_start' and time_end='$time_end' and fname='$fname'") or die (mysqli_error());
			...
			echo "<script>alert('Course already exist');</script>";
                                ...
                                mysqli_query($conn,"update classsched set day ='$day', time_start ='$time_start',
		 time_end ='$time_end', fname ='$fname', subject_code ='$subject_code', room_name='$room_name', course_year_section ='$course_year_section', semester ='$semester', sy ='$sy' where classid = '$get_id'") or die(mysqli_query($conn,));
                             echo"Saved";
                            }
							}
                            ?>
