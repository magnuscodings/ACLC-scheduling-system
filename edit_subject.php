...
while($course_row=mysqli_fetch_array($course_query)){
  ...
  <?php } ?>
                            ...
                            if (isset($_POST['update'])) {
                                ...
                                mysqli_query($conn,"update subject set subject_code='$subject_code',subject_title='$subject_title',subject_category='$subject_category',semester='$semester', course='$course',   where subjectid='$get_id'") or die(mysqli_error());
                             echo"Saved";
                            }
                            ?>
